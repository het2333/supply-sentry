...
Accepted capture: 2026-09-14 local public-demo run, tenant `t:public-demo`, generation 17.

## Deliverables

| Artifact | Technical result | SHA-256 |
| --- | --- | --- |
| `docs/assets/supplysentry-demo.gif` | 18.01 s, 1280×720, 468,233 bytes | `fb73bbcb1bdb5814e7bd949adcbfc73cbeeaef898a6ad36fecf4fae88c34894f` |
| `docs/assets/supplysentry-demo-poster.png` | 1440×900, 187,235 bytes | `3e0753aa11b836f7567828ccc90362ea263eceb0a5ae3d507604891914c5d213` |
| `artifacts/media/supplysentry-demo/supplysentry-walkthrough.mp4` | 61.00 s, H.264, 1920×1080, `yuv420p`, 764,399 bytes | `34a88cface93ac82a958271de625acec35014eb7ff2015accbdcf88df3f138d6` |
...
- A `429` response pauses capture for the server-provided `Retry-After` window and reloads the scene; a scene that remains limited is rejected instead of published.
...
| No scene contains a rate-limit, loading, or request failure state | Pass |
