...
// Only platform-authored runtime diagnostics are UI copy. Arbitrary adapter
// messages (even ones such as "Pending") must remain the original evidence.
const LOCALIZED_HEALTH_MESSAGES = new Set([
  "真实适配器已加载",
  "运行时正常；尚未配置必需凭据",
]);
